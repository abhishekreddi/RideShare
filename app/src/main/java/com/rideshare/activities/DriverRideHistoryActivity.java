...
public class DriverRideHistoryActivity {
    package com.rideshare.activities;
...
import retrofit2.Response;
    ...
    public class DriverRideHistoryActivity extends AppCompatActivity {
        ...
        public void getMyRideHistory(){
            progressDialog = new ProgressDialog(com.rideshare.activities.DriverRideHistoryActivity.this);
            ...
            call.enqueue(new Callback<List<MyRideHistoryPojo>>() {
                ...
                public void onFailure(Call<List<MyRideHistoryPojo>> call, Throwable t) {
                    ...
                    Toast.makeText(com.rideshare.activities.DriverRideHistoryActivity.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
                }
            });
        }
        @Override
