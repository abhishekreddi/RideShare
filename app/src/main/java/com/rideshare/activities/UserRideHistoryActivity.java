...
public class UserRideHistoryActivity extends AppCompatActivity {
    ...
    public void getMyRideHistory(){
        progressDialog = new ProgressDialog(UserRideHistoryActivity.this);
        ...
        call.enqueue(new Callback<List<MyRideHistoryPojo>>() {
            ...
            public void onResponse(Call<List<MyRideHistoryPojo>> call, Response<List<MyRideHistoryPojo>> response) {
                ...
                if(response.body()==null){
                    Toast.makeText(UserRideHistoryActivity.this,"No data found",Toast.LENGTH_SHORT).show();
                }else {
                    myRideHistoryPojo = response.body();
                    list_view.setAdapter(new RideHistoryAdapter(myRideHistoryPojo, UserRideHistoryActivity.this));
            ...
            public void onFailure(Call<List<MyRideHistoryPojo>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(UserRideHistoryActivity.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
