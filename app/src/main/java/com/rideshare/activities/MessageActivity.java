...
public class MessageActivity extends AppCompatActivity {
    ...
    ProgressDialog pd;
    Button send;
    com.rideshare.adapters.messagesadapter messagesadapter;
    Runnable r;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(MessageActivity.this,getIntent().getStringExtra("rid").toString()+getIntent().getStringExtra("from").toString()+getIntent().getStringExtra("to").toString(), Toast.LENGTH_SHORT).show();
        ...
        call.enqueue(new Callback<ResponseData>() {
            ...
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                ...
                if (response.body().message.equals("true")) {
                    // pd.dismiss();
                    Toast.makeText(MessageActivity.this, response.body().message, Toast.LENGTH_LONG).show();
