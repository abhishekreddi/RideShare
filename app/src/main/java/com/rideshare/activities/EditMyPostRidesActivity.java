...
public class EditMyPostRidesActivity extends AppCompatActivity {
    ...
    private void UpdateMyPostRides() {
        String source=spinFrom.getSelectedItem().toString();
        String dest=SpinTo.getSelectedItem().toString();
        ...
        Call<ResponseData> call = service.editmypostride(source,dest,seats,date,amount,time,getRid);
