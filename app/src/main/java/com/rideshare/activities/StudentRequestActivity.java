...
import com.rideshare.adapters.StudentRequestAdapter;
...
public class StudentRequestActivity extends AppCompatActivity {
    ...
    StudentRequestAdapter myRequestAdapter;
    String session;
    @Override
    ...
    public void serverData(){
        progressDialog = new ProgressDialog(StudentRequestActivity.this);
        progressDialog.setMessage("Loading....");
        progressDialog.show();

        ApiService service = RetroClient.getRetrofitInstance().create(ApiService.class);
        Call<List<msgs>> call = service.studentchats(session);
        call.enqueue(new Callback<List<msgs>>() {
            ...
            public void onFailure(Call<List<msgs>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(StudentRequestActivity.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
